...
// inserindo o animal leão
    Animal(
        'Ambientes Semi-Aquaticos','Desconhecido','36 a 66kg',"Macho ou Femêa",'Capivara','',
        'de 54 á  64cm','Mamifero Roedor','Herbivoro'),
...
// inserindo o animal Gorila
    Animal(
        'Bioma temperado e tropical','Aprox. 3.500','de 520 a 1.100kg','Macho/femea','Tubarão Branco','',
        'de 4 a 6m de comprimento','Peixe','Carnivoro'),
